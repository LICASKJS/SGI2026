...
const pages = [
  ...
  },
  {
    ...
    sheet: "AUD COMP",
    sheetLabel: "AUD COMP",
    sheetAliases: ["AUD COMP", "AUDITORIA COMPORTAMENTAL"],
  ...
  },
  {
    ...
    sheetLabel: "GARANTIA DE QUALIDADE DE VIDA",
    sheetAliases: ["GARANTIA DE QUA DE VIDA", "GARANTIA DE QUALIDADE DE VIDA"],
    file: "racs-fora-prazo.html",
    navLabel: "Qualidade de Vida",
    icon: "heart",
    heroTitle: "Qualidade de Vida",
    view: "table",
  ...
  },
  {
    ...
    sheetLabel: "AÇÕES CORRETIVAS",
    sheetAliases: ["RNC", "RNCs", "AÇÕES CORRETIVAS"],
    file: "racs-vencidas.html",
    navLabel: "RNCs",
    icon: "alert-triangle",
    heroTitle: "RNCs - Ações Corretivas",
    view: "table",
    description: "Painel das RNCs (Não Conformidades) e seus prazos conforme cadastro oficial.",
  },
  {
    id: "programas",
    sheet: "PROGRAMAS",
    sheetLabel: "PROGRAMAS",
    sheetAliases: ["PROGRAMAS"],
    file: "analise.html",
    navLabel: "Programas / Campanhas",
    icon: "layers",
    heroTitle: "Programas / Campanhas",
    view: "table",
    description: "Acompanhamento dos programas ativos e campanhas realizadas.",
  },
  {
    id: "campanhas",
    sheet: "PROGRAMAS",
    sheetLabel: "PROGRAMAS",
    sheetAliases: ["PROGRAMAS", "CAMPANHAS"],
    file: "campanhas.html",
    navLabel: "Campanhas",
    icon: "megaphone",
    heroTitle: "Campanhas",
...
const navGroups = [
  {
    id: "acidentes",
    label: "Segurança",
    pages: ["acidentes-c-afastamento", "acidentes-s-afastamento", "observatorio"],
  },
  {
    id: "avaliacoes",
    label: "Auditoria",
  ...
  {
    id: "iniciativas",
    label: "Programas / Campanhas",
    pages: ["programas", "campanhas"],
  },
  {
    id: "saude",
    label: "Saúde",
...
const iconTemplates = {
  ...
  alertTriangle: '<path d="M12 3l9 16H3z" /><path d="M12 9v4" /><path d="M12 17h.01" />',
